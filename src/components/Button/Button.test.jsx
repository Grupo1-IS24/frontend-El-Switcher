...
describe('Button', () => {
  ...
  const baseClasses = 'text-3xl w-80 py-6 bg-white text-black hover:bg-black hover:text-white';
  const buttonStyles = [
    ...
    { style: 'gameButton_leave', class: 'fixed top-3 right-3 w-11 h-11 rounded text-2xl border-2 border-[#ee6055] bg-[#ee6055] text-[#0c0c0c] hover:bg-transparent hover:text-[#ee6055]' },
    { style: 'gameButton_play', class: 'w-[16rem] h-[4.375rem] text-2xl border-2 border-[#000000] bg-[#000000] text-[#f1f1f1] hover:bg-transparent hover:text-[#f1f1f1]' },
    { style: 'gameButton_cancelMovement', class: 'w-[16rem] h-[4.375rem] text-2xl border-2 border-[#ee6055] bg-[#ee6055] text-[#0c0c0c] hover:bg-transparent hover:text-[#ee6055]' },
  ];
